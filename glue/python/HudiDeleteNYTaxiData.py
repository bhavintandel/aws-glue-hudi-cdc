...
incrementalConfig = {'hoodie.upsert.shuffle.parallelism': 68, 'hoodie.datasource.write.operation': 'upsert', 'hoodie.cleaner.policy': 'KEEP_LATEST_COMMITS', 'hoodie.cleaner.commits.retained': 10, 'hoodie.datasource.write.payload.class': 'org.apache.hudi.common.model.EmptyHoodieRecordPayload'}
combinedConf = {**commonConfig, **unpartitionDataConfig, **incrementalConfig}
deleteDf = spark.sql("select * from default.ny_yellow_trip_data where vendorid = 9")
glueContext.write_dynamic_frame.from_options(
    frame = DynamicFrame.fromDF(deleteDf, glueContext, "deleteDf"), 
